...
class KotlinFileGeneratorSpec : BddSpec({
    ...
    "generate code with basic template" {
        ...
        result shouldContain "import dev.ktool.ktml.Context"
    ...
    "generate code with content parameter" {
        ...
        Then
        result shouldContain "import dev.ktool.ktml.Content"
        result shouldContain "import dev.ktool.ktml.Context"
        result shouldContain """
    ...
    "generate code with no parameters" {
        ...
        result shouldNotContain "import dev.ktool.ktml.Content"
    }
